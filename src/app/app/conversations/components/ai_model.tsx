...
export default function AiModel({imageURL,name,tags,configurationId}:{imageURL?:string,name:string,tags?:string[],configurationId:string}) {
  return (
    <div className='w-[400px] h-[150px] rounded-md p-2 flex flex-row items-center bg-blue-700'>
        ...
        <div className='pl-1 flex flex-col h-full flex-grow justify-between'>
            ...
            <div className='w-[200px]'>
                <Link href={`/app/conversations/talk/${configurationId}`}>
